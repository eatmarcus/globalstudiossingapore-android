...
//        mSelectedProduct = context.getProductDB().getProductByName(key);
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (!hasRecordingStoragePermissions(ARActivity.this)) {
...
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(ARActivity.this, ProductDetailActivity.class);
...
//        productModel.loadModel(Uri.parse(), Object3D.Type.FBX, new AsyncObject3DListener() {
//            @Override
//            public void onObject3DLoaded(Object3D object3D, Object3D.Type type) {
...
//        productModel.loadModel(Uri.parse("file:///android_asset/mario.obj"), Object3D.Type.OBJ, new AsyncObject3DListener() {
        productModel.loadModel(Uri.parse(fileLocation), Object3D.Type.OBJ, new AsyncObject3DListener() {
            ...
            public void onObject3DFailed(String s) {
                Log.e("Viro"," Model load failed : " + s);
            }
        });
